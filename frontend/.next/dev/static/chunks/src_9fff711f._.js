...
function ConcertCard(t0) {
    ...
    if ($[0] !== "738903946c7c8aa422af7e7f2a47ab4958782f39060fe05a31206df0d50825a7") {
        for(let $i = 0; $i < 27; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "738903946c7c8aa422af7e7f2a47ab4958782f39060fe05a31206df0d50825a7";
    }
...
function Dashboard() {
    ...
    if ($[0] !== "fd1cbbcad21f2f4474868d383cc00ccf6a58249a46830ace92f253af842015ca") {
        for(let $i = 0; $i < 39; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "fd1cbbcad21f2f4474868d383cc00ccf6a58249a46830ace92f253af842015ca";
    }
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("overview");
    const [concerts, setConcerts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(INITIAL_CONCERTS);
    ...
    const [formValues, setFormValues] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t0);
    let t1;
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ({
            "Dashboard[showToast]": (message, t2)=>{
                const variant = t2 === undefined ? "success" : t2;
                setToast({
                    message,
                    variant
    ...
    if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = ({
            "Dashboard[handleDelete]": (id, name)=>{
                setConcerts({
                    "Dashboard[handleDelete > setConcerts()]": (prev)=>prev.filter({
                            "Dashboard[handleDelete > setConcerts() > prev.filter()]": (concert)=>concert.id !== id
                        }["Dashboard[handleDelete > setConcerts() > prev.filter()]"])
                }["Dashboard[handleDelete > setConcerts()]"]);
    ...
    const handleCloseToast = t3;
    let t4;
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = ({
            "Dashboard[handleFormChange]": (key, value)=>{
                setFormValues({
                    "Dashboard[handleFormChange > setFormValues()]": (prev_0)=>({
                            ...prev_0,
                            [key]: value
                        })
                }["Dashboard[handleFormChange > setFormValues()]"]);
            }
        })["Dashboard[handleFormChange]"];
        $[5] = t4;
    } else {
        t4 = $[5];
    }
    const handleFormChange = t4;
    let t5;
    if ($[6] !== formValues.description || $[7] !== formValues.name || $[8] !== formValues.totalSeats) {
        t5 = ({
            "Dashboard[handleCreateSubmit]": (event)=>{
                ...
                const generatedId = typeof crypto !== "undefined" && "randomUUID" in crypto ? crypto.randomUUID() : `concert-${Date.now()}`;
                const newConcert = {
                    id: generatedId,
                    name: trimmedName,
                ...
                setConcerts({
                    "Dashboard[handleCreateSubmit > setConcerts()]": (prev_1)=>[
                            ...prev_1,
                            newConcert
                        ]
                }["Dashboard[handleCreateSubmit > setConcerts()]"]);
                setFormValues({
                    name: "",
                    totalSeats: "",
                    description: ""
        ...
        })["Dashboard[handleCreateSubmit]"];
        $[6] = formValues.description;
        $[7] = formValues.name;
        $[8] = formValues.totalSeats;
        $[9] = t5;
    } else {
        t5 = $[9];
    }
    const handleCreateSubmit = t5;
    const t6 = Boolean(toast);
    const t7 = toast?.message ?? "";
    const t8 = toast?.variant ?? "success";
    let t9;
    ...
    let t10;
    if ($[14] !== concerts) {
        t10 = concerts.reduce(_DashboardConcertsReduce, 0);
        $[14] = concerts;
        $[15] = t10;
    } else {
        t10 = $[15];
    ...
    if ($[22] === Symbol.for("react.memo_cache_sentinel")) {
        t15 = ({
            "Dashboard[<Tabs>.onChange]": (key_0)=>setActiveTab(key_0)
        })["Dashboard[<Tabs>.onChange]"];
        $[22] = t15;
    } else {
        t15 = $[22];
    }
    ...
    let t17;
    if ($[25] !== activeTab || $[26] !== concerts || $[27] !== formValues.description || $[28] !== formValues.name || $[29] !== formValues.totalSeats || $[30] !== handleCreateSubmit) {
        t17 = activeTab === "overview" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "flex flex-col gap-6",
            children: [
                concerts.map({
                    "Dashboard[concerts.map()]": (concert_1)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ConcertCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ConcertCard"], {
                            name: concert_1.name,
                            description: concert_1.description,
                            totalSeats: concert_1.totalSeats,
                            onConfirmDelete: {
                                "Dashboard[concerts.map() > <ConcertCard>.onConfirmDelete]": ()=>handleDelete(concert_1.id, concert_1.name)
                            }["Dashboard[concerts.map() > <ConcertCard>.onConfirmDelete]"]
                        }, concert_1.id, false, {
                            fileName: "[project]/src/components/Dashboard.tsx",
                            lineNumber: 223,
                            columnNumber: 51
                        }, this)
                }["Dashboard[concerts.map()]"]),
                concerts.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                    ...
                                    onChange: {
                                        "Dashboard[<input>.onChange]": (event_0)=>handleFormChange("name", event_0.target.value)
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            ...
                                            onChange: {
                                                "Dashboard[<input>.onChange]": (event_1)=>handleFormChange("totalSeats", event_1.target.value)
                                            }["Dashboard[<input>.onChange]"],
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("textarea", {
                            ...
                            onChange: {
                                "Dashboard[<textarea>.onChange]": (event_2)=>handleFormChange("description", event_2.target.value)
        ...
        $[25] = activeTab;
        $[26] = concerts;
        $[27] = formValues.description;
        $[28] = formValues.name;
        $[29] = formValues.totalSeats;
        $[30] = handleCreateSubmit;
        $[31] = t17;
    } else {
        t17 = $[31];
    }
...
_s(Dashboard, "DSr13zqvfhmWRGLnfSXp11F/uQc=");
_c = Dashboard;
function _DashboardConcertsReduce(sum, concert_0) {
    return sum + concert_0.totalSeats;
}
var _c;
...
function UserPage() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(20);
    if ($[0] !== "35f27d1799d11a9e0d9bced2d7a612c73ade5d9432caafead7ef042c13c9c0be") {
        for(let $i = 0; $i < 20; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "35f27d1799d11a9e0d9bced2d7a612c73ade5d9432caafead7ef042c13c9c0be";
    }
    const [concerts, setConcerts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(USER_CONCERTS);
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = [];
        $[1] = t0;
    ...
    const [, setHistory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t0);
    const [toast, setToast] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    let t1;
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ({
            "UserPage[showToast]": (message, t2)=>{
                const variant = t2 === undefined ? "success" : t2;
                setToast({
                    message,
                    variant
    ...
    if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = ({
            "UserPage[updateHistory]": (concertName, action)=>{
                setHistory({
                    "UserPage[updateHistory > setHistory()]": (prev)=>[
                            {
                                id: `history-${Date.now()}`,
                ...
                }["UserPage[updateHistory > setHistory()]"]);
            }
        })["UserPage[updateHistory]"];
        $[3] = t2;
    } else {
        t2 = $[3];
    }
    const updateHistory = t2;
    let t3;
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = ({
            "UserPage[handleReserve]": (id)=>{
                setConcerts({
                    "UserPage[handleReserve > setConcerts()]": (prev_0)=>prev_0.map({
                            "UserPage[handleReserve > setConcerts() > prev_0.map()]": (concert)=>{
                                if (concert.id !== id) {
                                    return concert;
                                }
                                if (concert.reserved) {
                        ...
                        }["UserPage[handleReserve > setConcerts() > prev_0.map()]"])
                }["UserPage[handleReserve > setConcerts()]"]);
            }
        })["UserPage[handleReserve]"];
        $[4] = t3;
    } else {
        t3 = $[4];
    }
    ...
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = ({
            "UserPage[handleCancel]": (id_0)=>{
                setConcerts({
                    "UserPage[handleCancel > setConcerts()]": (prev_1)=>prev_1.map({
                            "UserPage[handleCancel > setConcerts() > prev_1.map()]": (concert_0)=>{
                                if (concert_0.id !== id_0) {
                                    return concert_0;
                                }
                                if (!concert_0.reserved) {
                                    showToast("No reservation found to cancel.", "info");
                                    return concert_0;
                                }
                                updateHistory(concert_0.name, "Cancel");
                                showToast(`Cancelled ${concert_0.name} successfully`);
                                return {
                                    ...concert_0,
                                    reserved: false,
                                    availableSeats: concert_0.availableSeats + 1
                                };
                            }
                        }["UserPage[handleCancel > setConcerts() > prev_1.map()]"])
                }["UserPage[handleCancel > setConcerts()]"]);
            }
        })["UserPage[handleCancel]"];
        $[5] = t4;
    } else {
        t4 = $[5];
    }
    ...
    if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
        t9 = ({
            "UserPage[<Toast>.onClose]": ()=>setToast(null)
        })["UserPage[<Toast>.onClose]"];
        $[7] = t9;
    } else {
        t9 = $[7];
    }
    ...
    if ($[12] !== concerts) {
        ...
        if ($[14] === Symbol.for("react.memo_cache_sentinel")) {
            t12 = ({
                "UserPage[concerts.map()]": (concert_1)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "rounded-2xl border border-[#D0D5DD] bg-white p-6 shadow-sm",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "border-b border-[#E4E7EC] pb-4",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "mt-4 text-base leading-relaxed text-[#101828]",
                                children: concert_1.description
                            }, void 0, false, {
                                fileName: "[project]/src/app/user/page.tsx",
                                lineNumber: 189,
                                columnNumber: 274
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "text-base font-medium",
                                                children: [
                                                    concert_1.availableSeats.toLocaleString(),
                                                    " / ",
                                                    concert_1.totalSeats.toLocaleString(),
                                                    " seats available"
                                                ]
                                            }, void 0, true, {
                                                fileName: "[project]/src/app/user/page.tsx",
                                    ...
                                    concert_1.reserved ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        text: "Cancel",
                                        variant: "danger",
                                        onClick: {
                                            "UserPage[concerts.map() > <Button>.onClick]": ()=>handleCancel(concert_1.id)
                                        }["UserPage[concerts.map() > <Button>.onClick]"]
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/user/page.tsx",
                                        lineNumber: 189,
                                        columnNumber: 672
                                        ...
                                        borderColor: "#1692EC",
                                        onClick: {
                                            "UserPage[concerts.map() > <Button>.onClick]": ()=>handleReserve(concert_1.id)
                                        }["UserPage[concerts.map() > <Button>.onClick]"],
                                        disabled: concert_1.availableSeats <= 0,
                                        className: concert_1.availableSeats <= 0 ? "cursor-not-allowed opacity-60" : ""
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/user/page.tsx",
                                        lineNumber: 191,
                                        columnNumber: 68
                            ...
                            concert_1.availableSeats <= 0 && !concert_1.reserved ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            ...
            })["UserPage[concerts.map()]"];
            $[14] = t12;
        } else {
            t12 = $[14];
        }
        t11 = concerts.map(t12);
        $[12] = concerts;
        $[13] = t11;
    } else {
        t11 = $[13];
...
_s(UserPage, "CaSXT70Svcvm2pqM74NUAJjPiAs=");
_c = UserPage;
var _c;
...
//# sourceMappingURL=src_9fff711f._.js.map