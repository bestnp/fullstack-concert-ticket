...
function ConcertCard(t0) {
    ...
    if ($[0] !== "16727736ec0691c71f9058f3c4a42f828b8aa48f8f94c3a13fbc12afb9b9e678") {
        for(let $i = 0; $i < 27; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "16727736ec0691c71f9058f3c4a42f828b8aa48f8f94c3a13fbc12afb9b9e678";
    }
...
function Toast(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(17);
    if ($[0] !== "9e0078c975490115cd233e0d6d8a4ae21964ad32d56fb07ea87244d72ac70353") {
        for(let $i = 0; $i < 17; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "9e0078c975490115cd233e0d6d8a4ae21964ad32d56fb07ea87244d72ac70353";
    }
    ...
    const t5 = `flex min-w-[240px] max-w-sm items-center gap-3 rounded-lg px-4 py-3 shadow-md ${VARIANT_STYLES[variant]}`;
    let t6;
    if ($[6] !== variant) {
...
function Dashboard() {
    ...
    if ($[0] !== "981cbc6c2f3e829b46c33dcaeb6514e1b6a5ae3aed2b397ba6900f33100d2e0c") {
        for(let $i = 0; $i < 31; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "981cbc6c2f3e829b46c33dcaeb6514e1b6a5ae3aed2b397ba6900f33100d2e0c";
    }
    ...
    const [dismissedConcerts, setDismissedConcerts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t0);
    ...
    let t5;
    let t6;
    if ($[2] !== activeTab || $[3] !== dismissedConcerts || $[4] !== toastMessage) {
        let t7;
        if ($[11] !== dismissedConcerts) {
            t7 = ({
                "Dashboard[CONCERTS.filter()]": (concert)=>!dismissedConcerts.has(concert.id)
            })["Dashboard[CONCERTS.filter()]"];
            $[11] = dismissedConcerts;
            $[12] = t7;
        } else {
            t7 = $[12];
        }
        const visibleConcerts = CONCERTS.filter(t7);
        let t8;
        if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
            t8 = ({
                "Dashboard[handleDelete]": (id, name)=>{
                    setDismissedConcerts({
                        "Dashboard[handleDelete > setDismissedConcerts()]": (prev)=>new Set(prev).add(id)
                    }["Dashboard[handleDelete > setDismissedConcerts()]"]);
                    setToastMessage(`Delete ${name} successfully`);
                }
        ...
        const handleCloseToast = t9;
        t4 = "flex flex-1 flex-col gap-10 px-10 py-10";
        const t10 = Boolean(toastMessage);
        const t11 = toastMessage ?? "";
        if ($[15] !== t10 || $[16] !== t11) {
        ...
        t1 = "mx-auto w-full max-w-5xl space-y-6";
        let t12;
        if ($[19] === Symbol.for("react.memo_cache_sentinel")) {
            t12 = ({
                "Dashboard[<Tabs>.onChange]": (key)=>setActiveTab(key)
        ...
        t3 = activeTab === "overview" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "flex flex-col gap-6",
            children: [
                visibleConcerts.map({
                    "Dashboard[visibleConcerts.map()]": (concert_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ConcertCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ConcertCard"], {
                            name: concert_0.name,
                            description: concert_0.description,
                            totalSeats: concert_0.totalSeats,
                            onConfirmDelete: {
                                "Dashboard[visibleConcerts.map() > <ConcertCard>.onConfirmDelete]": ()=>handleDelete(concert_0.id, concert_0.name)
                            }["Dashboard[visibleConcerts.map() > <ConcertCard>.onConfirmDelete]"]
                        }, concert_0.id, false, {
                            fileName: "[project]/src/components/Dashboard.tsx",
                            lineNumber: 120,
                            columnNumber: 58
                        }, this)
                }["Dashboard[visibleConcerts.map()]"]),
                visibleConcerts.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        children: "No concerts remaining."
                    }, void 0, false, {
                        fileName: "[project]/src/components/Dashboard.tsx",
                        lineNumber: 123,
                        columnNumber: 186
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                    className: "text-xl font-semibold text-[#1275D1]",
                    children: "Create"
                }, void 0, false, {
                    fileName: "[project]/src/components/Dashboard.tsx",
                    lineNumber: 123,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: "Start building your next concert experience. Place your form or creation flow here."
                }, void 0, false, {
                    fileName: "[project]/src/components/Dashboard.tsx",
                    lineNumber: 123,
                    columnNumber: 410
...
_s(Dashboard, "Qepf9pShSNobMUBAKvACOKCFORc=");
_c = Dashboard;
var _c;
...
function Sidebar() {
    ...
    if ($[0] !== "99bd30710c2d134f26413f08cbd814ec8c6bdf16ff3093c99a87e582a5be7a11") {
        for(let $i = 0; $i < 22; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "99bd30710c2d134f26413f08cbd814ec8c6bdf16ff3093c99a87e582a5be7a11";
    }
    ...
    if ($[20] !== t7) {
        t9 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
            className: "flex w-[240px] flex-shrink-0 flex-col border-r border-gray-200 bg-white px-[8px]",
            children: [
                t7,
                t8
            ]
...
//# sourceMappingURL=src_bd249571._.js.map