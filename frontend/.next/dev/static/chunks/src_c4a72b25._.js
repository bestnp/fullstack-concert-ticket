...
function UserPage() {
    ...
    const showToast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UserPage.useCallback[showToast]": (message, variant = 'success')=>{
            setToast({
                message,
                variant
            });
        }
    }["UserPage.useCallback[showToast]"], []);
    const handleCloseToast = ()=>{
        setToast(null);
    };
    const loadConcerts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UserPage.useCallback[loadConcerts]": async (currentUser)=>{
            setLoadingConcerts(true);
            try {
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getConcerts"])({
                ...
                setConcerts(data.map({
                    "UserPage.useCallback[loadConcerts]": (concert)=>({
                            id: concert.id,
                            name: concert.name,
                ...
                }["UserPage.useCallback[loadConcerts]"]));
            } catch (error) {
                console.error(error);
                showToast('Failed to load concerts', 'error');
            } finally{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserPage.useEffect": ()=>{
            const bootstrap = {
                "UserPage.useEffect.bootstrap": async ()=>{
                    try {
    ...
    const handleReserve = async (concertId)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reserveConcert"])({
                userId: user.id,
                concertId
            });
            ...
            console.error(error_1);
            showToast(error_1 instanceof Error ? error_1.message : 'Failed to reserve concert', 'error');
        } finally{
            setProcessingId(null);
        }
    };
    const handleCancel = async (concertId_0)=>{
        if (!user) return;
        setProcessingId(concertId_0);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cancelReservation"])({
                userId: user.id,
                concertId: concertId_0
            });
            await loadConcerts(user);
            showToast('Cancelled reservation successfully');
        } catch (error_2) {
            console.error(error_2);
            showToast(error_2 instanceof Error ? error_2.message : 'Failed to cancel reservation', 'error');
        } finally{
            setProcessingId(null);
        }
    };
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        children: [
                                                            ...
                                                            " /",
                                                            ' ',
                                                            concert_0.totalSeats.toLocaleString(),
                                                            " seats available"
                                                        ]
                                                    }, void 0, true, {
                                                        fileName: "[project]/src/app/user/page.tsx",
                                            ...
                                            concert_0.reservedByUser ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                text: "Cancel",
                                                variant: "danger",
                                    ...
                                    concert_0.availableSeats <= 0 && !concert_0.reservedByUser ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(UserPage, "JBwGEcKXo3N7hijdESFJ5j2Bqv0=");
_c = UserPage;
var _c;
...
//# sourceMappingURL=src_c4a72b25._.js.map